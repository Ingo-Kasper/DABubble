...
import { RouterOutlet } from '@angular/router'; // Erlaubt das Einbinden von Routeninhalten in die Komponente
...
@Component({
  ...
  imports: [RouterOutlet], // Importiert zusätzliche Angular-Module für diese Komponente, hier RouterOutlet für Routing
